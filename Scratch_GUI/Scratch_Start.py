...
def read_state():
	error_file = open('/home/pi/Desktop/GoBox/Scratch_GUI/selected_state', 'r')		# File: selected state
	in_string = ""
...
class MainPanel(wx.Panel):
	...
	def OnEraseBackground(self, evt):
		...
		dc.Clear()	
		bmp = wx.Bitmap("/home/pi/Desktop/GoBox/Scratch_GUI/dex.png")	# Draw the photograph.
	...
	def start_programming(self, event):
		...
		# Start Scratch
		start_command = "sudo  sh /home/pi/Desktop/GoBox/Scratch_GUI/scratch_direct /home/pi/Desktop/GoBox/Scratch_GUI/new.sb"
		send_bash_command_in_background(start_command)
		'''
	...
	def curriculum_update(self, event):
		...
		if internet_on():
			...
			send_bash_command("sudo cp /home/pi/Desktop/GoBox/Scratch_GUI/Scratch_Start.desktop /home/pi/Desktop")	# Move icons to desktop
...
class MainFrame(wx.Frame):
	...
	def __init__(self):
		...
		wx.Icon('/home/pi/Desktop/GoBox/Scratch_GUI/favicon.ico', wx.BITMAP_TYPE_ICO)
